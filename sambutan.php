...
<div class="container mt-3 mb-5">
  <div class="card custom-card p-4 mt-3 mb-5 text-center">
    <div class="row justify-content-center">
      <div class="col-md-8">
        <img src="galeri/kepala sekolah.png" alt="Kepala Sekolah" style="width: 160px; height: auto;" class="mb-3" />
        ...
        <p class="text-muted small text-start">
          ...
          tentang sekolah kami sehingga dapat mempererat tali silaturahmi antara sekolah dengan masyarakat demi kemajuan kita bersama.<br><br>
          ...
          Kritik dan sarannya yang membangun sangat kami harapkan untuk pengembangan ke depan.<br><br>

          Akhirnya, saya mengucapkan terima kasih yang sebesar-besarnya kepada semua pihak yang tidak dapat disebutkan satu
          persatu atas fasilitasnya yang telah diberikan semoga semua yang kita lakukan bermanfaat bagi masyarakat.
        </p>

        <p class=" text-muted text-start">Wassalamu’alaikum Warahmatullahi Wabarakatuh</p>
